#from pylibrm import RMAxis as Axis_V6
...
axis_tcp = pylibrm.RMAxis.Axis_V6.create_modbus_tcp('169.254.86.223' , 502, 1)
#axis_rtu = pylibrm.RMAxis.Axis_V6.create_modbus_rtu('\\\\.\\COM8', 1, 115200)


axis_tcp.set_b0_state(1)

axis_tcp.set_b1_state(1)

axis_tcp.set_b3_state(1)
...
axis_tcp.set_f1(1.22)
axis_tcp.set_f2(2.33)
axis_tcp.set_f3(3.44)
axis_tcp.save_parameters()
#外部传感器
#axis_out =pylibrm.RMAxis.Axis_V6.create_modbus_rtu('\\\\.\\COM5', 7, 115200)
