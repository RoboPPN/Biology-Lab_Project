...
# log_dir = os.path.join(base_dir, 'log')
# print(log_dir)
# LogManager.init_logger(global_area="DRIVER", level=LogLevel.WARNING, log_to_file=False, file_mode='a')
# logger = LogManager.get_logger(global_area="DRIVER")
# print(LogManager.get_log_file_path("DRIVER"))
# logger.error("This is a message from SubModule1.")
# LogManager.update_logger(global_area="DRIVER",local_area="SubModule1", level=LogLevel.DEBUG, log_to_file=True,file_mode='w',force_update=True)
# logger = LogManager.get_logger(global_area="DRIVER")
# logger.info("This is a message from SubModule111111.")
# LogManager.update_logger(global_area="DRIVER",local_area="SubModule2", level=LogLevel.DEBUG, log_to_file=True,file_mode='a',force_update=True)
# logger = LogManager.get_logger(global_area="DRIVER")
# a=2
